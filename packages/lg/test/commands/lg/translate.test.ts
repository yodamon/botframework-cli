  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, frOutputName),
        path.join(verifiedFolderPath, frOutputName)
      );
    });
});
...
describe('lg:translate to zh-cn', async () => {
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, cnOutputName),
        path.join(verifiedFolderPath, cnOutputName)
      );
    });
});
...
describe('lg:translate to zh-cn with comments', async () => {
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputCommentsName),
        path.join(verifiedFolderPath, outputCommentsName)
      );
    });
});
...
describe('lg:translate to zh-cn with translate_link_text', async () => {
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputLinkName),
        path.join(verifiedFolderPath, outputLinkName)
      );
    });
});

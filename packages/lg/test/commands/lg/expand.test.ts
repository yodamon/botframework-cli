...
describe('lg:expand lg template', async () => {
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, outputFileName)
      );
    });
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, '4.template.expand.lg')
      );
    });
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, '4.inline.expand.lg')
      );
    });
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, '4.testinput.expand.lg')
      );
    });
});
...
describe('lg:expand lg template with scope', async () => {
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, 'accessScope.testinput.expand.lg')
      );
    });
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, 'accessScope2.testinput.expand.lg')
      );
    });
  ...
  test
    ...
    .it('', async () => {
      await TestUtil.compareFiles(
        path.join(generatedFolderPath, outputFileName),
        path.join(verifiedFolderPath, 'accessScope3.testinput.expand.lg')
      );
    });
});

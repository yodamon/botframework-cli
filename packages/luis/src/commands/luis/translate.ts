...
export default class LuisTranslate extends Command {
  ...
  static flags: flags.Input<any> = {
    in: flags.string({
      char: 'i',
      description: 'Source .lu file(s) or LUIS application JSON model',
    }),
    recurse: flags.boolean({
      char: 'r',
      description:
        'Indicates if sub-folders need to be considered to file .lu file(s)',
    }),
    out: flags.string({
      char: 'o',
      description:
    ...
    translate_comments: flags.boolean({
      description: 'When set, machine translate comments found in .lu file',
    }),
    translate_link_text: flags.boolean({
      description: 'When set, machine translate link description in .lu file',
    }),
    force: flags.boolean({
      char: 'f',
      description:
  ...
  async run() {
    try {
      ...
      if (isLu) {
        ...
        const translatedLuFiles = await luTranslator.translateLuList(
          luFiles,
          flags.translatekey,
          flags.tgtlang,
          flags.srclang,
        ...
        const translatedLuis = await luTranslator.translateLu(
          translation,
          flags.translatekey,
          flags.tgtlang,
          flags.srclang,

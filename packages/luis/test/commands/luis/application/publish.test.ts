...
describe('luis:application:publish', () => {
    ...
    .nock('https://westus.api.cognitive.microsoft.com', (api) =>
      api
        ...
        .reply(201, {
          ...
          isStaging: true,
          endpointUrl:
            'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/4e3d6aec-f79e-4688-b686-feaf6dc2feee',
          region: 'westus',
          endpointRegion: 'westus',
          failedRegions: '',
          publishedDateTime: '2019-11-21T21:54:30Z',
        })
    )
    .stdout()
    .command([
  ...
  test
    ...
    .it(
      'publishes a luis app with optional flags and displays the published app data',
      (ctx) => {
        expect(ctx.stdout).to.contain('versionId');
        expect(ctx.stdout).to.contain('isStaging');
        expect(ctx.stdout).to.contain('endpointUrl');

...
describe('luis:application:query', () => {
    ...
    .it(
      ...
      (ctx) => {
        expect(ctx.stderr).to.contain(
          `Required input property 'query' missing.`
        );
      }
    );
  ...
  test
    ...
    .it(
      'queries an application for intent predictions and displays the results',
      (ctx) => {
  ...
  test
    ...
    .it(
      'fails to query app and displays an error message if the endpoint is null',
      (ctx) => {

...
describe('luis:build cli parameters test', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      `${path.join(__dirname, './../../fixtures/testcases/lubuild')}`,
      '--botName',
      'Contoso',
    ])
    .it(
      'displays an error if any required input parameters are missing',
      (ctx) => {
        expect(ctx.stderr).to.contain(
          'Missing LUIS authoring key. Please pass authoring key with --authoringKey flag'
        );
      }
    );
  ...
  test
    ...
    .it(
      ...
      (ctx) => {
        expect(ctx.stderr).to.contain(
          'Missing input. Please use stdin or pass a file or folder location with --in flag'
        );
      }
    );
  ...
  test
    ...
    .it(
      ...
      (ctx) => {
        expect(ctx.stderr).to.contain(
          'Missing bot name. Please pass bot name with --botName flag'
        );
      }
    );
  ...
  test
    ...
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/testcases/lubuild/file-name-duplicated'
      )}`,
      '--botName',
      'Contoso',
    ])
    .it(
      'displays an error if files with same name and locale are found',
      (ctx) => {
        expect(ctx.stderr).to.contain(
          'Files with same name and locale are found'
        );
      }
    );
  ...
  test
    ...
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/testcases/invalid_import_file.lu'
      )}`,
      '--botName',
      'Contoso',
    ])
    .it('displays an error if error occurs in parsing lu content', (ctx) => {
      ...
      expect(ctx.stderr).to.contain(
        "[ERROR] line 4:0 - line 4:16: Invalid intent body line, did you miss '-' at line begin"
      );
    });
  ...
  test
    ...
    .it(
      'displays an error if option specified by --dialog is not right',
      (ctx) => {
        expect(ctx.stderr).to.contain(
          'Recognizer type specified by --dialog is not right. Please specify [multiLanguage|crosstrained]'
        );
      }
    );
});
...
describe('luis:build create a new application successfully', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/sandwich//lufiles/sandwich.en-us.lu',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
...
describe('luis:build not update application if no changes', () => {
  ...
  test
    ...
    .it(
      'should not update a luis application when there are no changes for the coming lu file',
      (ctx) => {
        expect(ctx.stdout).to.contain('Handling applications...');
...
describe('luis:build write dialog assets successfully if --dialog set to multiLanguage', () => {
  ...
  test
    ...
    .it(
      'should write dialog assets successfully when --dialog set to multiLanguage',
      async (ctx) => {
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
            './../../fixtures/testcases/lubuild/sandwich/config/luis.settings.development.westus.json'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/sandwich.en-us.lu.dialog',
            './../../fixtures/testcases/lubuild/sandwich/dialogs/sandwich.en-us.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/sandwich.lu.dialog',
            './../../fixtures/testcases/lubuild/sandwich/dialogs/sandwich.lu.dialog'
          )
        ).to.be.true;
      }
    );
...
describe('luis:build write dialog assets successfully if --dialog set to crosstrained', () => {
  ...
  test
    ...
    .it(
      'should write dialog assets successfully when --dialog set to crosstrained',
      async (ctx) => {
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
        ...
        expect(
          await compareFiles(
            './../../../results/sandwich.lu.qna.dialog',
            './../../fixtures/testcases/lubuild/sandwich/dialogs/sandwich.lu.qna.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
...
describe('luis:build write crosstrained recognizer asset successfully if lu file is empty and --dialog set to crosstrained', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/empty-file/lufiles/empty.lu',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
    ...
    .it(
      'should write crosstrained recognizer asset successfully when lu file is empty and --dialog set to crosstrained',
      async (ctx) => {
        expect(
          await compareFiles(
            './../../../results/empty.lu.qna.dialog',
            './../../fixtures/testcases/lubuild/empty-file/dialogs/empty.lu.qna.dialog'
          )
        ).to.be.true;
      }
    );
...
describe('luis:build create multiple applications successfully when input is a folder', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/foo/lufiles',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
    ...
    .it(
      'should create multiple applications and write dialog assets successfully when input is a folder',
      async (ctx) => {
        ...
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
            './../../fixtures/testcases/lubuild/foo/config/luis.settings.development.westus.json'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.lu.dialog',
            './../../fixtures/testcases/lubuild/foo/dialogs/foo.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.en-us.lu.dialog',
            './../../fixtures/testcases/lubuild/foo/dialogs/foo.en-us.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.fr-fr.lu.dialog',
            './../../fixtures/testcases/lubuild/foo/dialogs/foo.fr-fr.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.zh-cn.lu.dialog',
            './../../fixtures/testcases/lubuild/foo/dialogs/foo.zh-cn.lu.dialog'
          )
        ).to.be.true;
      }
    );
...
describe('luis:build update dialog assets successfully when dialog assets exist', () => {
  ...
  before(async function () {
    ...
    nock('https://westus.api.cognitive.microsoft.com')
      .get(
        (uri) =>
          uri.includes('apps') &&
          uri.includes('f8c64e2a-2222-3a09-8f78-39d7adc76ec5')
      )
      .reply(200, {
        name: 'test(development)-foo.en-us.lu',
        id: 'f8c64e2a-2222-3a09-8f78-39d7adc76ec5',
    ...
    nock('https://westus.api.cognitive.microsoft.com')
      .get(
        (uri) =>
          uri.includes('apps') &&
          uri.includes('f8c64e2a-1111-3a09-8f78-39d7adc76ec5')
      )
      .reply(200, {
        name: 'test(development)-foo.fr-fr.lu',
        id: 'f8c64e2a-1111-3a09-8f78-39d7adc76ec5',
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/foo2/lufiles-and-dialog-assets',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
    ...
    .it(
      'should update dialog assets successfully when dialog assets exist',
      async (ctx) => {
        expect(ctx.stdout).to.contain('foo.fr-fr.lu loaded');
        expect(ctx.stdout).to.contain('foo.lu loaded');
        expect(ctx.stdout).to.contain('foo.zh-cn.lu loaded');
        ...
        expect(ctx.stdout).to.contain(
          'luis.settings.development.westus.json loaded'
        );
        ...
        expect(ctx.stdout).to.contain(
          '[WARN]: empty intent(s) # emptyIntent are filtered when handling luis application'
        );
        ...
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
            './../../fixtures/testcases/lubuild/foo2/config/luis.settings.development.westus.json'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.lu.dialog',
            './../../fixtures/testcases/lubuild/foo2/dialogs/foo.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.en-us.lu.dialog',
            './../../fixtures/testcases/lubuild/foo2/dialogs/foo.en-us.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.fr-fr.lu.dialog',
            './../../fixtures/testcases/lubuild/foo2/dialogs/foo.fr-fr.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/foo.zh-cn.lu.dialog',
            './../../fixtures/testcases/lubuild/foo2/dialogs/foo.zh-cn.lu.dialog'
          )
        ).to.be.true;
      }
    );
...
describe('luis:build not update application if only cases of utterances or patterns are changed', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/case-insensitive/lufiles/case-insensitive.lu',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
    ...
    .it(
      'should not update a luis application when only cases of utterances or patterns are different for the coming lu file',
      (ctx) => {
        expect(ctx.stdout).to.contain('Handling applications...');
        expect(ctx.stdout).to.contain('no changes');
      }
...
describe('luis:build update application succeed with parameters set from luconfig', () => {
  ...
  test
    ...
    .command([
      ...
      uuidv1(),
      '--luConfig',
      './test/fixtures/testcases/lubuild/luconfig/lufiles/luconfig.json',
      '--log',
      '--suffix',
      'development',
    ])
    .it(
      'should update a luis application when utterances changed',
      async (ctx) => {
        expect(ctx.stdout).to.contain('Handling applications...');
        expect(ctx.stdout).to.contain('creating version=0.2');
        ...
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
            './../../fixtures/testcases/lubuild/luconfig/config/luis.settings.development.westus.json'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/test.en-us.lu.dialog',
            './../../fixtures/testcases/lubuild/luconfig/dialogs/test.en-us.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/test.lu.dialog',
            './../../fixtures/testcases/lubuild/luconfig/dialogs/test.lu.dialog'
          )
        ).to.be.true;
      }
    );
...
describe('luis:build create a new application successfully with locale set to it-it', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/file-with-personName/personName.en-us.lu',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
    ...
    .it(
      'should create a new application successfully for prebuilt entity personName with locale set to it-it',
      (ctx) => {
        expect(ctx.stdout).to.contain('Handling applications...');
        expect(ctx.stdout).to.contain('Creating LUIS.ai application');
        expect(ctx.stdout).to.contain('training version=0.1');
        ...
        expect(
          ctx.stdout.includes(
            'personName is not available for the requested locale: it-it'
          )
        ).to.be.false;
      }
    );
...
describe('luis:build update application succeed when activeVersion is null', () => {
  ...
  test
    ...
    .it(
      'should update a luis application when activeVersion is null',
      (ctx) => {
        expect(ctx.stdout).to.contain('Handling applications...');
        expect(ctx.stdout).to.contain('creating version=0.2');
        expect(ctx.stdout).to.contain('training version=0.2');
...
describe('luis:build create a new application successfully with endpoint override', () => {
  ...
  test
    ...
    .it(
      'should create a new application successfully with endpoint override',
      (ctx) => {
        expect(ctx.stdout).to.contain('Handling applications...');
        expect(ctx.stdout).to.contain('Creating LUIS.ai application');
        expect(ctx.stdout).to.contain('training version=0.1');
...
describe('luis:build write dialog assets successfully if schema is specified', () => {
  ...
  test
    ...
    .it(
      'should write dialog assets successfully if schema is specified',
      async (ctx) => {
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
        ...
        expect(
          await compareFiles(
            './../../../results/sandwich.en-us.lu.dialog',
            './../../fixtures/testcases/lubuild/sandwich/dialogs-with-schema/sandwich.en-us.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/sandwich.lu.dialog',
            './../../fixtures/testcases/lubuild/sandwich/dialogs-with-schema/sandwich.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/sandwich.lu.qna.dialog',
            './../../fixtures/testcases/lubuild/sandwich/dialogs-with-schema/sandwich.lu.qna.dialog'
          )
        ).to.be.true;
      }
    );
...
describe('luis:build write dialog assets successfully when empty files exist', () => {
  ...
  test
    ...
    .command([
      'luis:build',
      '--in',
      './test/fixtures/testcases/lubuild/empty-file/lufiles',
      '--authoringKey',
      uuidv1(),
      '--botName',
      'test',
    ...
    .it(
      'should write dialog assets successfully when empty files exist',
      async (ctx) => {
        ...
        expect(
          await compareFiles(
            './../../../results/luis.settings.development.westus.json',
            './../../fixtures/testcases/lubuild/empty-file/config/luis.settings.development.westus.json'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/non-empty.lu.dialog',
            './../../fixtures/testcases/lubuild/empty-file/dialogs/non-empty.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/non-empty.en-us.lu.dialog',
            './../../fixtures/testcases/lubuild/empty-file/dialogs/non-empty.en-us.lu.dialog'
          )
        ).to.be.true;
        expect(
          await compareFiles(
            './../../../results/non-empty.lu.qna.dialog',
            './../../fixtures/testcases/lubuild/empty-file/dialogs/non-empty.lu.qna.dialog'
          )
        ).to.be.true;
      }
    );

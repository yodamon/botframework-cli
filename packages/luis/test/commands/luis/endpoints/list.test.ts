...
describe('luis:endpoints:list', () => {
  ...
  test
    .nock('https://westus.api.cognitive.microsoft.com', (api) =>
      api
        ...
        .reply(200, {
          westus:
            'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/99999',
        })
    )
    .stdout()
    .command([
  ...
  test
    ...
    .it(
      'displays a list of endpoints and a success message in the console (since the target path provided is invalid)',
      (ctx) => {

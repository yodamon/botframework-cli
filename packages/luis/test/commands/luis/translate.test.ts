...
describe('luis:translate lu file', async () => {
  ...
  test
    .command([
      ...
      'xxxxxxx',
      '--in',
      `${path.join(__dirname, './../../fixtures/file.lu')}`,
      '--tgtlang',
      'fr',
      '--out',
      './',
...
describe('luis:translate luis json', async () => {
  ...
  test
    .command([
      ...
      'xxxxxxx',
      '--in',
      `${path.join(__dirname, './../../fixtures/root.luis.json')}`,
      '--tgtlang',
      'fr',
      '--out',
      './',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../fr/root.luis.json',
        './../../fixtures/translation/fr/root.luis.json'
      );
    });
});
...
describe('luis:translate Phrase list entity references are translated correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/phraseList.lu'
      )}`,
      '--tgtlang',
      'de',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/phraseList.lu',
        './../../fixtures/translation/translatedfiles/phraseList.lu'
      );
    });
});
...
xdescribe('luis:translate References can be skipped from being translated', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/fileRef.lu'
      )}`,
      '--tgtlang',
      'de',
      '--out',
...
describe('luis:translate Intents and utterances are translated correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/intentsAndUtterances.lu'
      )}`,
      '--tgtlang',
      'fr',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../fr/intentsAndUtterances.lu',
        './../../fixtures/translation/translatedfiles/intentsAndUtterances.lu'
      );
    });
});
...
describe('luis:translate All entity types are translated correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/allEntities.lu'
      )}`,
      '--tgtlang',
      'de',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/allEntities.lu',
        './../../fixtures/translation/translatedfiles/allEntities.lu'
      );
    });
});
...
describe('luis:translate Labelled entity values are translated correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/labelledEntityValue.lu'
      )}`,
      '--tgtlang',
      'de',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/labelledEntityValue.lu',
        './../../fixtures/translation/translatedfiles/labelledEntityValue.lu'
      );
    });
});
...
describe('luis:translate Translate for new entity type is handled correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/newEntity.lu'
      )}`,
      '--tgtlang',
      'fr',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../fr/newEntity.lu',
        './../../fixtures/translation/translatedfiles/newEntity.lu'
      );
    });
});
...
describe('luis:translate For list entities, normalized value is added as synonym', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/normalizedValue.lu'
      )}`,
      '--tgtlang',
      'fr',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../fr/normalizedValue.lu',
        './../../fixtures/translation/translatedfiles/normalizedValue.lu'
      );
    });
});
...
describe('luis:translate Options in utterance are translated correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/options.lu'
      )}`,
      '--tgtlang',
      'de',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/options.lu',
        './../../fixtures/translation/translatedfiles/options.lu'
      );
    });
});

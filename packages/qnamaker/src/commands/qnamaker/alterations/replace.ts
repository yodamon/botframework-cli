...
export default class QnamakerAlterationsReplace extends Command {
  ...
  static flags: flags.Input<any> = {
    in: flags.string({
      char: 'i',
      description:
        'File path to the WordAlterationsDTO object to send in the body of the request',
    }),
    ...
    help: flags.help({
      char: 'h',
      description: 'qnamaker:alterations:replace command help',
    }),
  };

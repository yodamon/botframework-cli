...
describe('qnamaker:kb:create', () => {
  before(async function () {
    ...
    nock('https://westus.api.cognitive.microsoft.com/qnamaker/v4.0')
      ...
      .reply(200, {
        ...
        resourceLocation:
          '/knowledgebases/8600c573-2acf-4466-97e8-999ad4cecbc2',
  ...
  test
    ...
    .command([
      'qnamaker:kb:create',
      '--in',
      `${path.join(__dirname, '../../../fixtures/kb.json')}`,
    ])
...
describe('qnamaker:kb:create --save', () => {
  ...
  test
    ...
    .it('Creates kb and awaits for the creation of it', async () => {
      ...
      expect(config.qnamaker__kbId).to.contain(
        '8600c573-2acf-4466-97e8-999ad4cecbc2'
      );
    });
});

...
describe('qnamaker:translate qna.lu', () => {
  ...
  test
    ...
    .command([
      ...
      'xxxxxxx',
      '--in',
      `${path.join(__dirname, './../../fixtures/translation/en/qna.lu')}`,
      '--tgtlang',
      'fr',
      '--out',
      './',
    ...
    .it(
      'runs qnamaker:translate --translatekey xxxxxx --in file.lu --tgtlang fr --out ./',
      async (ctx) => {
        await compareLuFiles(
          './../../../fr/qna.lu',
          './../../fixtures/translation/fr/qna.lu'
        );
      }
    );
});
...
xdescribe('qnamaker:translate qna.json', () => {
  ...
  test
    ...
    .command([
      ...
      'xxxxxxx',
      '--in',
      `${path.join(__dirname, './../../fixtures/translation/en/qna.json')}`,
      '--tgtlang',
      'fr',
      '--out',
      './',
    ...
    .it('', async (ctx) => {
      await compareLuFiles(
        './../../../fr/qna.json',
        './../../fixtures/translation/fr/qna.json'
      );
    });
});
...
describe('qnamaker:translate QnA content is translated correctly', async () => {
  ...
  test
    .command([
      ...
      'xxxxxxx',
      '--in',
      `${path.join(__dirname, './../../fixtures/translation/files/qna.lu')}`,
      '--tgtlang',
      'de',
      '--out',
      './',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/qna.lu',
        './../../fixtures/translation/translatedfiles/qna.lu'
      );
    });
});
...
describe('qnamaker:translate QnA content is translated correctly', async () => {
  ...
  test
    .command([
      ...
      `${path.join(
        __dirname,
        './../../fixtures/translation/files/qnaContent.lu'
      )}`,
      '--tgtlang',
      'de',
      '--out',
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/qnaContent.lu',
        './../../fixtures/translation/translatedfiles/qnaContent.lu'
      );
    });
});
...
describe('qnamaker:translate QnA link references are translated correctly', async () => {
  ...
  test
    ...
    .it('', async () => {
      await compareLuFiles(
        './../../../de/fileRef.lu',
        './../../fixtures/translation/translatedfiles/fileRef.lu'
      );
    });
});

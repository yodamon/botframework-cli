  ...
  createRequest(pathFragment, params, method, dataModel = null) {
    ...
    if (this.useEndpoint)
      headers.Authorization =
        'EndpointKey ' + ServiceBase.config.endpointKey || params.endpointKey;
    else
      headers['Ocp-Apim-Subscription-Key'] =
        ServiceBase.config.subscriptionKey || params.subscriptionKey;

    let requestEndpoint;
    if (this.useEndpoint) requestEndpoint = params.hostname;
    else

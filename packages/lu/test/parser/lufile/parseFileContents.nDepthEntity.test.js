  ...
  it('intent can be assigned as a feature', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.equal(res.LUISJsonStructure.entities[0].name, 'fooBar');
        assert.equal(
          res.LUISJsonStructure.entities[0].features[0].modelName,
          'intent1'
        );
        done();
      })
  ...
  it('Child entity name can have spaces in them', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.equal(res.LUISJsonStructure.entities[0].children.length, 1);
        assert.equal(
          res.LUISJsonStructure.entities[0].children[0].name,
          'x y z'
        );
        done();
      })
  ...
  it('Multiple children at level 1 is handled correctly', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.equal(res.LUISJsonStructure.entities[0].children[0].name, 'xyz');
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].name,
          'xyz2'
        );
        done();
      })
  ...
  it('Instance of a type is handled correctly', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].features[0].modelName,
          'number'
        );
        done();
      })
...
@ml 1 = 
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children.length,
          3
        );
        assert.equal(
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[0].features[0]
            .modelName,
          'number'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].name,
          '3'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children
            .length,
          '4'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[0]
            .name,
          'l3'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[0]
            .features[0].modelName,
          'list1'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
            .name,
          '4'
        );
        assert.equal(
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
            .children[0].features[0].modelName,
          'regex1'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
            .children[2].features[0].modelName,
          'list3'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
            .children[3].features[0].modelName,
          'number'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[1]
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[2]
            .name,
          'n3'
        );
        assert.equal(
        ...
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[1].children[3]
            .name,
          's3'
        );
        assert.equal(
          res.LUISJsonStructure.entities[0].children[1].children[2].name,
          's2'
        );
        done();
      })
  ...
  it('Child can include one feature', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.equal(res.LUISJsonStructure.entities[0].children[0].name, 's1');
        assert.deepEqual(
          res.LUISJsonStructure.entities[0].children[0].features,
          [new helperclasses.entityFeature('x1', false)]
        );
        done();
      })
      .catch((err) => done(err));
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.deepEqual(
          ...
          [
            new helperclasses.entityFeature('x1', false),
            new helperclasses.entityFeature('x2', false),
          ]
        );
        done();
      })
  ...
  it('Child can include intent as a feature', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.deepEqual(
          res.LUISJsonStructure.entities[0].children[0].features[0].modelName,
          'pa1'
        );
  ...
  it('Child can include phrase list as a feature', function (done) {
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.deepEqual(
          res.LUISJsonStructure.entities[0].children[0].features,
          [new helperclasses.plFeature('pl1', false)]
        );
    ...
    parseFile
      ...
      .then((res) => {
        ...
        assert.deepEqual(
          ...
          [
            new helperclasses.plFeature('pl1', false),
            new helperclasses.entityFeature('s1', false),
            new helperclasses.entityFeature('number', false),
          ]
        );
        assert.equal(res.LUISJsonStructure.phraselists.length, 1);
        assert.equal(res.LUISJsonStructure.phraselists[0].name, 'pl1');

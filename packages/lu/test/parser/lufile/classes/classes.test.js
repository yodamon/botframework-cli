...
describe('Testing all classes', function () {
  ...
  describe('QnA List class', function () {
    it('can create a new instance with explicit values as args', function () {
      assert.deepEqual(new QnAList(0, 'test', '1', ['2'], {}), {
        id: 0,
        answer: 'test',
        source: '1',
        questions: ['2'],
        metadata: {},
        context: new qnaContext(),
      });
    });
  ...
  describe('readerObj class', function () {
    it('can create a new instance with explicit values as args', function () {
      assert.deepEqual(new hClasses.readerObject('1', '2'), {
        sourceFile: '1',
        model: '2',
      });
    });
  ...
  describe('intent class', function () {
    it('can create a new instance with explicit values as args', function () {
      assert.deepEqual(new hClasses.intent('1', '2'), {
        intent: '1',
        utterances: '2',
      });
    });
  ...
  describe('pattern class', function () {
    ...
    it('can create a new instance with explicit values as args', function () {
      assert.deepEqual(new hClasses.pattern('1', '2'), {
        pattern: '1',
        intent: '2',
      });
    });
  ...
  describe('subList class', function () {
    ...
    it('can create a new instance with explicit values as args', function () {
      assert.deepEqual(new hClasses.subList('1', '2'), {
        canonicalForm: '1',
        list: '2',
      });
    });
  ...
  describe('closedLists class', function () {
    ...
    it('can create a new instance with explicit values as args', function () {
      assert.deepEqual(new hClasses.closedLists('1', '2', '3'), {
        name: '1',
        subLists: '2',
        roles: '3',
      });

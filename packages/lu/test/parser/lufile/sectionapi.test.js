...
describe('Section CRUD tests for intent', () => {
  ...
  it('init section test', () => {
    ...
    assert.equal(
      luresource.Sections[0].SectionType,
      LUSectionTypes.SIMPLEINTENTSECTION
    );
    assert.equal(luresource.Sections[0].Name, 'Greeting');
    assert.equal(luresource.Sections[0].UtteranceAndEntitiesMap.length, 2);
    assert.equal(
      luresource.Sections[0].UtteranceAndEntitiesMap[0].utterance,
      'hi'
    );
    assert.equal(
      luresource.Sections[0].UtteranceAndEntitiesMap[1].utterance,
      'hello'
    );
  });
  ...
  it('add simpleIntentSection test', () => {
    ...
    assert.equal(
      luresource.Sections[1].SectionType,
      LUSectionTypes.SIMPLEINTENTSECTION
    );
    assert.equal(luresource.Sections[1].Name, 'CheckEmail');
    assert.equal(luresource.Sections[1].UtteranceAndEntitiesMap.length, 2);
    assert.equal(
      luresource.Sections[1].UtteranceAndEntitiesMap[0].utterance,
      'check my email'
    );
    assert.equal(
      luresource.Sections[1].UtteranceAndEntitiesMap[1].utterance,
      'show my emails'
    );
  });
  ...
  it('update section test', () => {
    ...
    luresource = new SectionOperator(luresource).updateSection(
      luresource.Sections[1].Id,
      newFileConent
    );
    assert.equal(luresource.Errors.length, 0);
    assert.equal(luresource.Sections.length, 2);
    ...
    assert.equal(
      luresource.Sections[1].UtteranceAndEntitiesMap[2].utterance,
      'check my mail box please'
    );
    assert.isTrue(
      luresource.Sections[1].Body.includes(
        '> this is comment when updating simpleIntentSection'
      )
    );
    assert.isFalse(
  ...
  it('delete section test', () => {
    luresource = new SectionOperator(luresource).deleteSection(
      luresource.Sections[1].Id
    );
    ...
    assert.equal(luresource.Sections[0].Name, 'Greeting');
    assert.isFalse(
      luresource.Sections[0].Body.includes(
        '> this is comment when adding simpleIntentSection'
      )
    );
    assert.isFalse(
  ...
  it('add nestedIntentSection test with enableSections flag unset', () => {
    ...
    assert.equal(
      luresource.Sections[2].SectionType,
      LUSectionTypes.SIMPLEINTENTSECTION
    );
    ...
    assert.equal(
      luresource.Sections[2].UtteranceAndEntitiesMap[0].utterance,
      'check my unread email'
    );
    assert.equal(
      luresource.Sections[2].UtteranceAndEntitiesMap[1].utterance,
      'show my unread emails'
    );
    assert.equal(luresource.Sections[2].Entities.length, 1);
    assert.equal(
      luresource.Sections[2].Entities[0].SectionType,
      LUSectionTypes.NEWENTITYSECTION
    );
    ...
    assert.equal(
      luresource.Sections[3].SectionType,
      LUSectionTypes.SIMPLEINTENTSECTION
    );
    ...
    assert.equal(
      luresource.Sections[3].UtteranceAndEntitiesMap[0].utterance,
      'check my deleted email'
    );
    assert.equal(
      luresource.Sections[3].UtteranceAndEntitiesMap[1].utterance,
      'show my deleted emails'
    );
    assert.equal(
      luresource.Sections[3].Entities[0].SectionType,
      LUSectionTypes.NEWENTITYSECTION
    );
  ...
  it('add nestedIntentSection test with enableSections flag set', () => {
    ...
    luresource = luparser.parse(
      luresource.Content + NEWLINE + '> !# @enableSections = true'
    );
    luresource = new SectionOperator(luresource).addSection(newFileConent);
    ...
    assert.equal(
      luresource.Sections[1].SectionType,
      LUSectionTypes.NESTEDINTENTSECTION
    );
    assert.equal(luresource.Sections[1].Name, 'CheckEmail');
    assert.equal(luresource.Sections[1].SimpleIntentSections.length, 2);
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[0].Name,
      'CheckUnreadEmail'
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[0].Entities[0].SectionType,
      LUSectionTypes.NEWENTITYSECTION
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[0].Entities[0].Name,
      'emailTitle'
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[0].Entities[0].Type,
      'simple'
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[0].UtteranceAndEntitiesMap[1]
        .utterance,
      'show my unread emails'
    );

    assert.equal(
      luresource.Sections[1].SimpleIntentSections[1].Name,
      'CheckDeletedEmail'
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[1].Entities[0].SectionType,
      LUSectionTypes.NEWENTITYSECTION
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[1].Entities[0].Name,
      'emailSubject'
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[1].Entities[0].Type,
      'simple'
    );
    assert.equal(
      luresource.Sections[1].SimpleIntentSections[1].UtteranceAndEntitiesMap[0]
        .utterance,
      'check my deleted email'
    );
    ...
    assert.equal(
      luresource.Sections[3].Body,
      `## CheckUnreadTodo${NEWLINE}- check my unread todo${NEWLINE}- show my unread todos${NEWLINE}${NEWLINE}@ simple todoTitle${NEWLINE}${NEWLINE}## CheckDeletedTodo${NEWLINE}- check my deleted todo${NEWLINE}- show my deleted todos${NEWLINE}${NEWLINE}@ simple todoSubject`
    );
    assert.equal(luresource.Sections[3].SimpleIntentSections.length, 2);
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[0].Name,
      'CheckUnreadTodo'
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[0].Body,
      `- check my unread todo${NEWLINE}- show my unread todos${NEWLINE}${NEWLINE}@ simple todoTitle${NEWLINE}`
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[0].Entities[0].SectionType,
      LUSectionTypes.NEWENTITYSECTION
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[0].Entities[0].Name,
      'todoTitle'
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[0].Entities[0].Type,
      'simple'
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[0].UtteranceAndEntitiesMap[1]
        .utterance,
      'show my unread todos'
    );

    assert.equal(
      luresource.Sections[3].SimpleIntentSections[1].Name,
      'CheckDeletedTodo'
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[1].Entities[0].SectionType,
      LUSectionTypes.NEWENTITYSECTION
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[1].Entities[0].Name,
      'todoSubject'
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[1].Entities[0].Type,
      'simple'
    );
    assert.equal(
      luresource.Sections[3].SimpleIntentSections[1].UtteranceAndEntitiesMap[0]
        .utterance,
  ...
  it('update section test for invalid content', () => {
    ...
    assert.equal(
      luresource.Sections[0].Body,
      `> comment1${NEWLINE}- hi${NEWLINE}hello${NEWLINE}$${NEWLINE}@${NEWLINE}> comment2`
    );
  });
  ...
  it('update section test for invalid content2', () => {
    ...
    assert.equal(
      luresource.Sections[0].Body,
      `> comment1${NEWLINE}- hi${NEWLINE}$a${NEWLINE}> comment2`
    );
  });
  ...
  it('add section test for nested section content with comments', () => {
    ...
    assert.equal(
      luresource.Sections[4].SectionType,
      LUSectionTypes.NESTEDINTENTSECTION
    );
    assert.equal(luresource.Sections[4].Name, 'nestedIntentWithComments');
    assert.equal(
      luresource.Sections[4].SimpleIntentSections[0].Body,
      simpleIntentBody1
    );
    assert.equal(
      luresource.Sections[4].SimpleIntentSections[1].Body,
      simpleIntentBody2
    );
...
describe('Section CRUD tests for entity', () => {
  ...
  it('init section test', () => {
    let fileContent = `@ list BreadEntity =
    - multiGrainWheat:
        - multi
    - rye:
        - rye
...
- hi`;
  ...
  it('update entity section test', () => {
    let newFileConent = `@ list BreadEntity =
    - multiGrainWheat:
        - multi grain
    - white:
        - white`;
...
- cancel that`;
    ...
    assert.equal(luresource.Errors.length, 1);
    assert.equal(
      luresource.Errors[0].Message,
      "Invalid intent body line, did you miss '-' at line begin"
    );
    assert.equal(luresource.Sections.length, 2);
    assert.equal(
      luresource.Sections[0].Body,
      `- hi${NEWLINE}[]${NEWLINE}[${NEWLINE}]${NEWLINE}> @ ml city`
    );
...
describe('Section CRUD tests for qna', () => {
  ...
  let fileContent = `# ? who is CEO of Microsoft
- Microsoft CEO
...
\`\`\``;
  ...
  let addedFileContent = `# ? what about the weather of Seattle
...
\`\`\``;
  ...
  let updatedFileConent = `# ? who is CEO of Facebook
- Facebook CEO
...
\`\`\``;
  ...
  let insertFileContent = `# ? how to greet
...
\`\`\``;
  ...
  it('add qna section test', () => {
    ...
    assert.equal(
      luresource.Sections[1].Body.replace(/\r\n/g, '\n'),
      addedFileContent
    );
  });
  ...
  it('insert qna section at begining test', () => {
    luresource = new SectionOperator(luresource).insertSection(
      luresource.Sections[0].Id,
      insertFileContent
    );
    ...
    assert.equal(
      luresource.Sections[2].Body.replace(/\r\n/g, '\n'),
      addedFileContent
    );
  });
...
\`\`\``;
  ...
  let updatedQnAConent = `# ? who is CEO of Facebook
- Facebook CEO
...
\`\`\``;
  ...
  let insertQnAContent = `# ? how to greet

\`\`\`
hello
\`\`\``;

  let insertQnAContent2 = `# ? how to cancel

\`\`\`
cancel that
\`\`\``;

  let insertLuContent = `# welcome
- welcome here`;

  let insertLuContent2 = `# stop
- stop that`;
  ...
  it('update qna section test', () => {
    ...
    luresource = new SectionOperator(luresource).updateSection(
      luresource.Sections[0].Id,
      `${NEWLINE}${updatedQnAConent}${NEWLINE}`
    );
  ...
  it('insert qna section at middle test', () => {
    luresource = new SectionOperator(luresource).insertSection(
      luresource.Sections[1].Id,
      `${NEWLINE}${NEWLINE}${insertQnAContent2}${NEWLINE}`
    );
  ...
  it('insert lu section at begining test', () => {
    luresource = new SectionOperator(luresource).insertSection(
      luresource.Sections[0].Id,
      `${NEWLINE}${insertLuContent}${NEWLINE}${NEWLINE}`
    );
  ...
  it('update qna section with lu section test', () => {
    luresource = new SectionOperator(luresource).updateSection(
      luresource.Sections[3].Id,
      `${NEWLINE}${insertLuContent2}${NEWLINE}`
    );
...
describe('Section CRUD tests for import section', () => {
  ...
  let qnaContent = `# ? who is CEO of Microsoft
- Microsoft CEO
...
\`\`\``;
  ...
  it('insert qna section test', () => {
    luresource = luparser.parse(
      `${importContent1}${NEWLINE}${importContent2}${NEWLINE}${NEWLINE}${qnaContent}`
    );
    luresource = new SectionOperator(luresource).insertSection(
      luresource.Sections[2].Id,
      `${NEWLINE}${insertImportConent}`
    );
